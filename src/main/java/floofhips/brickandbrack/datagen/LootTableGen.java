...
public class LootTableGen extends ForgeLootTableProvider {
    ...
    private static class BlockProvider extends BlockLootTables
    {
        ...
        protected void addTables()
        {
            ...
            this.dropSelf(BlockInit.CLAY_ROOFING_BLOCK.get());
            this.dropSelf(BlockInit.CLAY_ROOFING_SLAB.get());
            this.dropSelf(BlockInit.CLAY_ROOFING_STAIRS.get());
            this.dropSelf(BlockInit.CLAY_TILE_BLOCK.get());
            this.dropSelf(BlockInit.SLATE_ROOFING_BLOCK.get());
            this.dropSelf(BlockInit.SLATE_ROOFING_SLAB.get());
            this.dropSelf(BlockInit.SLATE_ROOFING_STAIRS.get());
            this.dropSelf(BlockInit.SLATE_TILE_BLOCK.get());
            this.dropSelf(BlockInit.SHRUB.get());
            this.dropSelf(BlockInit.OAK_POLE.get());
            this.dropSelf(BlockInit.DIORITE_BRICKS.get());
            this.dropSelf(BlockInit.DIORITE_TILES.get());
            this.dropSelf(BlockInit.ANDESITE_TILES.get());
            this.dropSelf(BlockInit.ANDESITE_BRICKS.get());
            this.dropSelf(BlockInit.GRANITE_BRICKS.get());
            this.dropSelf(BlockInit.GRANITE_TILES.get());
            this.dropSelf(BlockInit.BASALT_BRICKS.get());
            this.dropSelf(BlockInit.BASALT_TILES.get());
            this.dropSelf(BlockInit.OBSIDIAN_BRICKS.get());
            this.dropSelf(BlockInit.CHISELED_ENDSTONE.get());
            this.dropSelf(BlockInit.CHISELED_PRISMARINE.get());
