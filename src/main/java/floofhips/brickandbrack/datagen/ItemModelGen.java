...
public class ItemModelGen implements IDataProvider {
    ...
    private void register() {
        this.generateFlatItem(ItemInit.TUNGSTEN_INGOT.get(), StockModelShapes.FLAT_ITEM);
    }
    ...
    private void generateFlatItem(Item item, String p_240077_2_, ModelsUtil modelsUtil) {
        modelsUtil.create(ModelsResourceUtil.getModelLocation(item, p_240077_2_), ModelTextures.layer0(ModelTextures.getItemTexture(item, p_240077_2_)), this.consumer);
    }

    private void generateFlatItem(Item item, Item p_240075_2_, ModelsUtil modelsUtil) {
        modelsUtil.create(ModelsResourceUtil.getModelLocation(item), ModelTextures.layer0(p_240075_2_), this.consumer);
    }
    ...
    public String getName() {
        return BrickAndBrack.MOD_ID + " Block State Definitions";
    }
}
